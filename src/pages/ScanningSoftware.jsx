...
const scanningSoftwareProducts = [
  {
    ...
    image: `${import.meta.env.BASE_URL}images/ScanningSoftwares_139_08.webp`,
    ...
    specs: [
      { label: 'Supported Platforms', value: 'Windows 7, 8, 10 (32/64 bit)' },
      { label: 'Integration', value: 'ECM, SharePoint, secure FTP' },
      { label: 'Indexing', value: 'Automated, advanced indexing' },
      { label: 'Batch Scanning', value: 'Yes, with job buttons' },
      { label: 'Quality Control', value: 'Intelligent Quality Control' },
      { label: 'Editions', value: 'Standard, Network, Auto Import, Limited' },
      { label: 'Languages', value: '16 GUI, 126 OCR' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Supported Platforms', value: 'Windows 7, 8, 10 (32/64 bit)' },
      { label: 'Batch Scanning', value: 'Yes, high-speed' },
      { label: 'Image Enhancement', value: 'Kofax VRS Elite built-in' },
      { label: 'Barcode Detection', value: 'Yes' },
      { label: 'Export', value: 'SharePoint, Kofax Capture, others' },
      { label: 'Indexing', value: 'Yes' },
      { label: 'Warranty', value: 'N/A' }
    ]
  },
  {
    ...
    specs: [
      { label: 'Supported Platforms', value: 'Windows 7, 8, 10 (32/64 bit)' },
      { label: 'Unlimited Scanning', value: 'Yes' },
      { label: 'Automated Data Capture', value: 'Barcode, QR, OCR, ICR, MICR, OMR, Smart Zone OCR' },
      { label: 'Database Integration', value: 'SQL, CSV, Excel, TXT' },
      { label: 'Reporting & Auditing', value: 'Yes, unmatched tools' },
      { label: 'Editions', value: 'Standalone, Network' },
      { label: 'Warranty', value: 'N/A' }
    ]
  },
];
